class Invoice:
    ...
    def totalTax(self, products):
        ...
        total_discount = round(total_tax, 2)
    ...
    def totalTaxPurePrice(self, products):
        new_total_pure_price = self.totalPurePrice(products) + self.totalTax(products)
        return new_total_pure_price
